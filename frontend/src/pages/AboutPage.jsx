  ...
  const timeline = [
    {
      ...
      description:
        "Brosa was born from the need for simpler restaurant ordering.",
    }, 
    {
      year: "2026",
      title: "Completing Pilot and Launch take off:",
      description:
        "Brosa completed pilot and is set to lunch with other demanding services and expanding organically.",
    },
  ];
